...
namespace diary_back.Context
{
    public partial class DataContext : DbContext
    {
        ...
        public DataContext(DbContextOptions<DataContext> options, IHttpContextAccessor httpContextAccessor, ITenantService tenantService)
            : base(options)
        {
        ...
        public virtual DbSet<Diaryentry> Diaryentries { get; set; } // Оголошено один раз
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Diaryentry>(entity =>
            {
                ...
                entity.Property(e => e.Date).HasColumnName("date"); // Додано
